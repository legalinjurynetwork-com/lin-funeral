                    ...
                    <div class="col-md-5">
                        ...
                        <form id="cover_form" method="POST" action="/post">
                            ...
                            <div class="register-form">
                                <h3 class="step-heading">Get Your FREE Quote <span aria-hidden="true"
                                ...
                                <div class="form-group">
                                    <label class="standard-label" for="postal_code">
                                ...
                                <div class="form-group submit-row form-group-submit">
                                    ...
                                    <button type="submit" class="btn btn-warning btn-lg btn-block">Get A Quote
                                        Now</button>
        ...
        <section id="sentence-2" class="section section-darker lower sentence-2 text-center">
            <div class="container">
                <div class="row">
                    ...
                    <div><a class="btn btn-main btn-lg uppercase" href="#hero">Get Quote Now</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer id="footer" class="section footer">
            <div class="container">
                <div class="footer-legal-note">
                    <p>
                        By clicking "Get Quote Now" you agree to our
