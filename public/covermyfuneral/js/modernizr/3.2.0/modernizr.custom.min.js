 ...
 * http://modernizr.com/download/?-applicationcache-audio-backgroundsize-bgsizecover-borderimage-borderradius-boxshadow-boxsizing-canvas-canvastext-cssanimations-csscolumns-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-flexbox-flexboxlegacy-fontface-generatedcontent-geolocation-hashchange-history-hsla-indexeddb-inlinesvg-input-inputtypes-localstorage-mediaqueries-multiplebgs-opacity-placeholder-postmessage-rgba-sessionstorage-smil-svg-svgclippaths-textshadow-touchevents-video-webgl-websockets-websqldatabase-webworkers-mq-setclasses-shiv !*/
! function(e, t, n) {
    function r(e) {
        var t = T.className,
    ...
    function o() {
        ...
        for (var c in b)
            if (b.hasOwnProperty(c)) {
                ...
                for (r = a(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++) i = e[o], s = i.split("."), 1 === s.length ? Modernizr[s[0]] = r : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), Modernizr[s[0]][s[1]] = r), y.push((r ? "" : "no-") + s.join("-"))
            }
    }
    ...
    function f(e, t, n) {
        var r;
        for (var o in e)
            if (e[o] in t) return n === !1 ? e[o] : (r = t[e[o]], a(r, "function") ? u(r, n || t) : r);
        return !1
    }
    ...
    function g(e, t, r, o) {
        ...
        for (var u, f, p, g, h, v = ["modernizr", "tspan"]; !I.style;) u = !0, I.modElem = i(v.shift()), I.style = I.modElem.style;
        for (p = e.length, f = 0; p > f; f++)
            if (g = e[f], h = I.style[g], s(g, "-") && (g = l(g)), I.style[g] !== n) {
                if (o || a(r, "undefined")) return c(), "pfx" == t ? g : !0;
                try {
                    I.style[g] = r
                } catch (y) {}
                if (I.style[g] != h) return c(), "pfx" == t ? g : !0
            }
        return c(), !1
    }
    ...
    function h(e, t, n, r, o) {
        ...
        return a(t, "string") || a(t, "undefined") ? g(s, t, r, o) : (s = (e + " " + D.join(i + " ") + i).split(" "), f(s, t, n))
    }
    ...
    }), Modernizr.addTest("placeholder", "placeholder" in i("input") && "placeholder" in i("textarea")), Modernizr.addTest("inlinesvg", function() {
        var e = i("div");
    ...
    x.hasEvent = S, Modernizr.addTest("hashchange", function() {
        return S("hashchange", e) === !1 ? !1 : t.documentMode === n || t.documentMode > 7
    });
    var C = i("input"),
        E = "autocomplete autofocus list placeholder max min multiple pattern required step".split(" "),
        k = {};
    Modernizr.input = function(t) {
        for (var n = 0, r = t.length; r > n; n++) k[t[n]] = !!(t[n] in C);
        return k.list && (k.list = !(!i("datalist") || !e.HTMLDataListElement)), k
    }(E);
    var P = "search tel url email datetime date month week time datetime-local number range color".split(" "),
        z = {};
    Modernizr.inputtypes = function(e) {
        for (var r, a, o, i = e.length, s = "1)", c = 0; i > c; c++) C.setAttribute("type", r = e[c]), o = "text" !== C.type && "style" in C, o && (C.value = s, C.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(r) && C.style.WebkitAppearance !== n ? (T.appendChild(C), a = t.defaultView, o = a.getComputedStyle && "textfield" !== a.getComputedStyle(C, null).WebkitAppearance && 0 !== C.offsetHeight, T.removeChild(C)) : /^(search|tel)$/.test(r) || (o = /^(url|email)$/.test(r) ? C.checkValidity && C.checkValidity() === !1 : C.value != s)), z[e[c]] = !!o;
        return z
    }(P);
    var _ = x._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];
    x._prefixes = _, Modernizr.addTest("cssgradients", function() {
        for (var e, t = "background-image:", n = "gradient(linear,left top,right bottom,from(#9f9),to(white));", r = "", a = 0, o = _.length - 1; o > a; a++) e = 0 === a ? "to " : "", r += t + _[a] + "linear-gradient(" + e + "left top, #9f9, white);";
    ...
    var N = "CSS" in e && "supports" in e.CSS,
        R = "supportsCSS" in e;
    Modernizr.addTest("supports", N || R);
    var $ = {}.toString;
    ...
    x.mq = A, Modernizr.addTest("mediaqueries", A("only all"));
    ...
    L ? Modernizr.addTest("fontface", !1) : M('@font-face {font-family:"font";src:url("https://")}', function(e, n) {
    ...
    var O = "Moz O ms Webkit",
        j = x._config.usePrefixes ? O.split(" ") : [];
    x._cssomPrefixes = j;
    var B = function(t) {
        var r, a = _.length,
            o = e.CSSRule;
    ...
    x.atRule = B;
    var D = x._config.usePrefixes ? O.toLowerCase().split(" ") : [];
    x._domPrefixes = D;
    var F = {
        elem: i("modernizr")
    };
    ...
    Modernizr.addTest("indexeddb", !!V), V && Modernizr.addTest("indexeddb.deletedatabase", "deleteDatabase" in V), x.testAllProps = v, Modernizr.addTest("cssanimations", v("animationName", "a", !0)), Modernizr.addTest("backgroundsize", v("backgroundSize", "100%", !0)), Modernizr.addTest("bgsizecover", v("backgroundSize", "cover")), Modernizr.addTest("borderimage", v("borderImage", "url() 1", !0)), Modernizr.addTest("borderradius", v("borderRadius", "0px", !0)), Modernizr.addTest("boxshadow", v("boxShadow", "1px 1px", !0)), Modernizr.addTest("boxsizing", v("boxSizing", "border-box", !0) && (t.documentMode === n || t.documentMode > 7)),
        function() {
            ...
            return e
        }), Modernizr.addTest("csstransitions", v("transition", "all", !0)), o(), r(y), delete x.addTest, delete x.addAsyncTest;
